...
function WalletProvider({ children }) {
    ...
    const connect = async ()=>{
        ...
        try {
            ...
            const balanceBN = balanceWei;
            const balanceNum = Number.parseInt(balanceBN, 16) / 1e18;
...
_s(WalletProvider, "L2mmoLUktiuGbpacOrWdRTxr6YY=");
_c = WalletProvider;
function useWallet() {
    _s1();
...
//# sourceMappingURL=_78de2871._.js.map